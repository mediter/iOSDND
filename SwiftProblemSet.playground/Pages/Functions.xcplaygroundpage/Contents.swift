...
func emojiLove(firstString: String, secondString: String) {
    print(firstString + "❤️" + secondString)
}

/* Example Function Call
 
 emojiLove(firstString: "cats", secondString: "dogs") // prints "cats ❤️ dogs"
 emojiLove(firstString: "udacity", secondString: "students") // prints "udacity ❤️ students"
 emojiLove(firstString: "peanut butter", secondString: "jelly") // prints "peanut butter ❤️ jelly"
 emojiLove(firstString: "ying", secondString: "yang") // prints "ying ❤️ yang"
 ...
 */
func funWithWords(_ inputString: String) -> String /* define the return type */ {
